...
namespace media_manager
{
    ...
    enum WatchingType
    {
        ...
        CACHE_WATCHING_FLV_BLOCK = 0x04,
        CACHE_WATCHING_FLV_FRAGMENT = 0x08,
        CACHE_WATCHING_TS_SEGMENT = 0x10,
        CACHE_WATCHING_SDP = 0x20,
        CACHE_WATCHING_RTP_BLOCK = 0x40,
        CACHE_WATCHING_ALL = 0x1f
    };
